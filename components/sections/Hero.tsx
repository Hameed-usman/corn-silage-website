          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <strong style={{ color: "rgba(255,255,255,.85)", fontWeight: 500 }}>verified nutrition.</strong>
              </p>
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "var(--font-display)", fontSize: 23, fontWeight: 700, color: "#C8973A", lineHeight: 1, marginBottom: 3 }}>Incoporation</div>
