...
import { SITE, CONTACT, CERTIFICATIONS, FOOTER_QUICK_LINKS, FOOTER_MARKETS } from "@/lib/constants";
  ...
  return (
    <>
      ...
      >
          ...
          <div className="ft-si" style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:32, flexWrap:"wrap" }}>
            ...
            <div style={{ maxWidth:520 }}>
              <Link href="/" aria-label={`${SITE.name} — homepage`} itemProp="url"
                ...
                <div style={{ width:44, height:44, borderRadius:12, background:"linear-gradient(135deg,#C8973A,#e8b84b)",
                  display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, flexShrink:0,
                  boxShadow:"0 4px 16px rgba(200,151,58,.38)" }} aria-hidden="true">🌿</div>
                <div>
                  <span itemProp="name" style={{ fontFamily:"var(--font-display)", fontSize:22, fontWeight:700,
                    color:"white", lineHeight:1, display:"block", letterSpacing:"-0.01em" }}>GreenValley</span>
                  <span style={{ fontSize:9, fontWeight:700, letterSpacing:".2em", textTransform:"uppercase",
                    color:"rgba(200,151,58,.65)", lineHeight:1, display:"block", marginTop:2 }}>Agri Exports</span>
                </div>
              </Link>
            ...
            {/* Right — trade card */}
            <div style={{ padding:"22px 26px", borderRadius:18, background:"rgba(255,255,255,.04)",
              border:"1px solid rgba(200,151,58,.14)", minWidth:220, flexShrink:0 }}>
              <p style={{ fontSize:9, fontWeight:700, textTransform:"uppercase", letterSpacing:".18em",
                color:"rgba(200,151,58,.55)", marginBottom:14 }}>Trade Information</p>
              {TRADE_ROWS.map((r) => (
        ...
        {/* Gold divider */}
        <div className="ft-div" aria-hidden="true" style={{ height:1, maxWidth:1280, margin:"0 auto",
        ...
        <div style={{ maxWidth:1280, margin:"0 auto", padding:"clamp(36px,5vh,52px) 2rem clamp(32px,5vh,48px)", position:"relative", zIndex:1 }}>
          <div className="ft-cols">
            ...
            {/* Markets */}
            <div className="ft-c">
              <nav aria-label="Export markets">
                <p className="ft-hdg">Markets</p>
                <ul style={{ listStyle:"none", padding:0, margin:0, display:"flex", flexDirection:"column", gap:10 }}>
                  {FOOTER_MARKETS.map((l) => (
        ...
        {/* Bottom bar */}
        <div className="ft-e" style={{ borderTop:"1px solid rgba(255,255,255,.06)", maxWidth:1280, margin:"0 auto",
